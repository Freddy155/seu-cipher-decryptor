...
const CipherDecryptor = () => {
  ...
  const encryptedMessage = "Zhofrph wr VHX Xqlyhuvlwb! Zh duh gholjkwhg wr kdyh brx zlwk xv wrgdb dv zh vkrzfdvh rxu dgydqfhphqwv lq frpsxwlqj vhfxulwb. Brxu ylvlw lv dq krqru, dqg zh orrn iruzdug wr lqvljkwixo glvfxvvlrqv dqg ixwxuh fROoderudwlrqv";
  
  const decryptedMessage = "Welcome to SEU University! We are delighted to have you with us today as we showcase our advancements in computing security. Your visit is an honor, and we look forward to insightful discussions and future cOLlaborations";
  ...
  }, [decrypting, progress, typingIndex, terminalCommands.length, decryptedMessage]);
    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 text-green-500 font-mono">
      <div className="max-w-3xl w-full bg-gray-900 rounded-lg shadow-xl border border-green-800 p-2 relative overflow-hidden">
        <div className="bg-gray-800 p-2 rounded-t-md flex items-center space-x-2 border-b border-green-900">
          ...
          <div className="ml-2 text-gray-400 flex-1 text-center text-sm">seu-university@terminal:~/security-demo</div>
        </div>
        ...
        <div className="p-4 relative z-10 overflow-auto h-full max-h-full">
          ...
          {showExplanation && (
            <div className="mb-8 bg-black bg-opacity-70 p-4 rounded border border-green-900">
              <div className="text-green-300 text-lg font-bold mb-2">-- THE CAESAR CIPHER --</div>
              
              <p className="mb-4 text-green-400">
                The Caesar cipher is one of the earliest encryption techniques, dating back to Julius Caesar who used it to communicate with his generals.
              </p>
              ...
              <div className="flex flex-col md:flex-row gap-4 mb-4">
                <div className="flex-1 bg-black bg-opacity-80 p-3 rounded border border-green-700">
                  ...
                  <p className="text-gray-300 mb-2">Each letter is shifted a fixed number of positions down the alphabet:</p>
                ...
                <div className="flex-1 bg-black bg-opacity-80 p-3 rounded border border-green-700">
                  <div className="text-green-500 mb-2">$ echo "HELLO" | ./caesar.sh -s 3</div>
                  <div className="text-gray-300 mb-1">Input: <span className="text-blue-300">HELLO</span></div>
                  <div className="text-gray-300 mb-1">Output: <span className="text-green-300">KHOOR</span></div>
              ...
              <p className="mb-4 text-green-400">
                The target message is encrypted using a Caesar cipher with shift=3. This simple algorithm represents the foundation of modern cryptography.
              </p>
          ...
          <div className="mb-6">
            {!showExplanation && (
              <>
                <div className="text-green-400 mb-2">[SEU-SECURITY]$ cat encrypted_message.txt</div>
                ...
                {!decryptionComplete && !decrypting && (
                  <button 
                    ...
                    className="bg-black hover:bg-green-900 text-green-500 font-bold py-2 px-4 rounded w-full transition-all duration-300 border border-green-600 text-left"
                  >
                    [SEU-SECURITY]$ <span className="animate-pulse">_</span>
                  </button>
                )}
                ...
                {(decrypting && typingIndex > 2) || decryptionComplete ? (
                  <div className="mt-6">
                    <div className="text-green-400 mb-2">[SEU-SECURITY]$ cat decrypted_output.txt</div>
                    <div className="bg-black p-3 rounded border border-green-800 shadow-inner relative overflow-hidden min-h-16">
                      ...
                      {!decryptionComplete && cursorVisible && <span className="text-green-500">▋</span>}
                    </div>
                  </div>
                ) : null}
                ...
                {decryptionComplete && (
                  <div className="mt-6 p-3 bg-green-900 bg-opacity-20 border border-green-700 rounded">
                    <div className="text-green-500 mb-2">[SEU-SECURITY]$ ./validation.sh --success</div>
                    <div className="text-green-400">
                      Decryption successful! Authentication complete.
                    </div>
                    <div className="text-green-300 my-2">
                      Thank you for participating in our security demonstration. Proceed to visitor check-in terminal.
                    </div>
                    <button 
                      onClick={resetDemo}
